    ...
    <el-form :model="form" :rules="rules" :disabled="mode=='show'" ref="dialogForm" label-width="100px"
      ...
      <template v-if="mode!='resetPassword'">
        ...
        <el-form-item label="所属部门" prop="dept">
          <el-cascader v-model="form.dept" :options="depts" :props="deptsProps" :placeholder="form.dept"
                       @change="handleChangeDept" clearable style="width: 100%;"></el-cascader>
        </el-form-item>
        <el-form-item label="所属角色">
          <el-cascader v-model="form.roleNames" :options="roleNames" :props="roleNamesProps"
                       :placeholder="form.roleNames" @change="handleChangeRole" clearable
