      ...
      <el-container>
        ...
        <el-main class="nopadding">
          <el-tree ref="menu" class="menu" node-key="id" :data="menuList" :props="menuProps"
                   :default-expanded-keys="defaultExpandedIds" draggable highlight-current :expand-on-click-node="false"
                   check-strictly show-checkbox @node-click="menuClick" @node-drop="nodeDrop">
