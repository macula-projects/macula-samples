<template>
  ...
  <save-dialog v-if="dialog.save" ref="saveDialog" @success="handleSaveSuccess" @closed="dialog.save=false"
               :dataScopeEnum="dataScopeEnum"></save-dialog>
  <resource-dialog v-if="dialog.resource" ref="resourceDialog" @success="handleSaveSuccess"
                   @closed="dialog.resource=false" :dataScopeEnum="dataScopeEnum"></resource-dialog>
</template>
